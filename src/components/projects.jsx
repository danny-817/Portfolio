  ...
  return (
    <div className=" " id="projects">
      ...
      <div className="projects-container ">
        <SnackTrack closeModal={closeModal} openModal={openModal} ref1={ref1} inView1={inView1} modals={modals}   />       
        <NcNews   closeModal={closeModal} openModal={openModal} ref2={ref2} inView2={inView2} modals={modals}  />        
        <NcNewsApi closeModal={closeModal} openModal={openModal} ref3={ref3} inView3={inView3} modals={modals} />
        <Portfolio closeModal={closeModal} openModal={openModal} ref4={ref4} inView4={inView4} modals={modals} />
      </div>
    </div>
  );
}
